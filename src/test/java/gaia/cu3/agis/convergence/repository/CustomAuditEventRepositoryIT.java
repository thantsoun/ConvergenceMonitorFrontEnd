...
import gaia.cu3.agis.convergence.config.audit.AuditEventConverter;
import gaia.cu3.agis.convergence.domain.PersistentAuditEvent;
...
import static gaia.cu3.agis.convergence.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
